...
public class Reachability {
    ...
    public enum Connection: CustomStringConvertible {
        ...
        public var description: String {
            switch self {
            case .cellular: return AppMessages.mobile
            case .wifi: return AppMessages.wifi
            case .unavailable: return AppMessages.noConnection
            case .none: return AppMessages.noConnection
            }
        }
    }
    ...
    required public init(reachabilityRef: SCNetworkReachability,
        ...
        self.reachabilitySerialQueue = DispatchQueue(label: "ug.code.DVT-Weather", qos: queueQoS, target: targetQueue)
